...
(function (root) {
  ...
  var FINDINGS = [
    ...
    { kind: 'Tape', title: 'The dfw object tape carries a second part after “SPACEWAR SYMZ”: by its form, a symbol table',
      text: 'The program’s blocks on spacewar4.1_2-20-63_dfw.bin end with jmp 7751, which sends the machine back into the loader. After the punched letters “SPACEWAR SYMZ” (frames 7963–8039) the loader reads on: 12 more blocks, every checksum good, 719 words at 6432–7750, then jmp 1411. The words run in 359 pairs; in 243 of them the second word is the value of a symbol in the 4.1 build, in the program’s order (6077 1j, 6117 1q, 3024 1sc, 6121 2j, 6141 2q, …), the form of a symbol table, which would fit “SYMZ”. The first words of the pairs, presumably the names, are not yet decoded. Loaded through to its end, the tape overwrites the star table at 6432–7750 in core. Found by running the tape through its own loader (Tape view, Load tape).',
